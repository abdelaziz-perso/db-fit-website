...
const linkClass =
  "inline-flex rounded-full p-2 text-zinc-500 transition-colors hover:text-brand-fg focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand dark:hover:text-brand";
...
export function SocialIconLinks({
  ...
  return (
    ...
    >
      ...
      >
        <InstagramGlyph className={iconClassName} />
      </a>
      <a
        ...
        aria-label="Facebook"
      >
        <FacebookGlyph className={iconClassName} />
      </a>
    </div>
  );
}
